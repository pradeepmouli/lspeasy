...
[lspeasy](../README.md) / RequestType5

# Class: RequestType5\<P1, P2, P3, P4, P5, R, E\>

Defined in: node\_modules/.pnpm/vscode-jsonrpc@8.2.0/node\_modules/vscode-jsonrpc/lib/common/messages.d.ts:226
...
> **new RequestType5**\<`P1`, `P2`, `P3`, `P4`, `P5`, `R`, `E`\>(`method`): `RequestType5`\<`P1`, `P2`, `P3`, `P4`, `P5`, `R`, `E`\>

Defined in: node\_modules/.pnpm/vscode-jsonrpc@8.2.0/node\_modules/vscode-jsonrpc/lib/common/messages.d.ts:231
...
`RequestType5`\<`P1`, `P2`, `P3`, `P4`, `P5`, `R`, `E`\>
...
> `readonly` **\_**: \[`P1`, `P2`, `P3`, `P4`, `P5`, `R`, `E`, [`_EM`](../interfaces/EM.md)\] \| `undefined`

Defined in: node\_modules/.pnpm/vscode-jsonrpc@8.2.0/node\_modules/vscode-jsonrpc/lib/common/messages.d.ts:230
