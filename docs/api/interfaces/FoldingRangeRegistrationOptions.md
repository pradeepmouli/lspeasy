...
[lspeasy](../README.md) / FoldingRangeRegistrationOptions

# Interface: FoldingRangeRegistrationOptions

Defined in: node\_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node\_modules/vscode-languageserver-protocol/lib/common/protocol.foldingRange.d.ts:77

General text document registration options.

## Extends

- [`TextDocumentRegistrationOptions`](TextDocumentRegistrationOptions.md).[`FoldingRangeOptions`](FoldingRangeOptions.md).[`StaticRegistrationOptions`](StaticRegistrationOptions.md)
...
[`FoldingRangeOptions`](FoldingRangeOptions.md).[`workDoneProgress`](FoldingRangeOptions.md#workdoneprogress)
