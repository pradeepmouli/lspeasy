...
[lspeasy](../README.md) / ImplementationRegistrationOptions

# Interface: ImplementationRegistrationOptions

Defined in: node\_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node\_modules/vscode-languageserver-protocol/lib/common/protocol.implementation.d.ts:24

General text document registration options.

## Extends

- [`TextDocumentRegistrationOptions`](TextDocumentRegistrationOptions.md).[`ImplementationOptions`](ImplementationOptions.md).[`StaticRegistrationOptions`](StaticRegistrationOptions.md)
...
[`ImplementationOptions`](ImplementationOptions.md).[`workDoneProgress`](ImplementationOptions.md#workdoneprogress)
